...
python_bin="${PYTHON_BIN:-/exp/exp8/acq22mc/StyleTTS2/.venv/bin/python}"
accel="${ACCELERATE_BIN:-/exp/exp8/acq22mc/StyleTTS2/.venv/bin/accelerate}"
issue_root="/exp/exp8/acq22mc/symphony-jobs/CDE-71/data_split_exp1/phoebe"
...
cde = config["model_params"]["cde"]["params"]
assert (cde["hidden_channels"], cde["num_layers"], cde["dt"]) == (256, 6, 0.5)
assert epochs < config["loss_params"]["joint_epoch"]
assert "data_split_exp1/phoebe/cde/" in config["log_dir"]
for path in (
...
configs=(
  "1m:esd_small_data_split_exp1_cde_1m:Configs/data_split_exp1/esd_small_data_split_exp1_cde_1m.yml:train_finetune_cde_accelerate.py"
  "5m:esd_small_data_split_exp1_cde_5m:Configs/data_split_exp1/esd_small_data_split_exp1_cde_5m.yml:train_finetune_cde_accelerate.py"
  "15m:esd_small_data_split_exp1_cde_15m:Configs/data_split_exp1/esd_small_data_split_exp1_cde_15m.yml:train_finetune_cde_accelerate.py"
  "30m:esd_small_data_split_exp1_cde_30m:Configs/data_split_exp1/esd_small_data_split_exp1_cde_30m.yml:train_finetune_cde_accelerate.py"
  "60m:esd_small_data_split_exp1_cde_60m:Configs/data_split_exp1/esd_small_data_split_exp1_cde_60m.yml:train_finetune_cde_accelerate.py"
)
